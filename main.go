...
import (
	...
	"github.com/shawt/Arduino-Create-for-iForge/tools"
...
var (
	version               = "2.0.0" //don't modify it, Jenkins will take care
	...
	port                  string
	portSSL               string
	origins               = flag.String("origins", "https://if.genlrn.com", "Allowed origin list for CORS")
